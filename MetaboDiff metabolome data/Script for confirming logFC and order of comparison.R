...
#   [1] raw: SummarizedExperiment with 323 rows and 4 columns
# Features:
...
#   [1] raw: SummarizedExperiment with 323 rows and 4 columns
# [2] imputed: SummarizedExperiment with 323 rows and 4 columns
# Features:
#   experiments() - obtain the ExperimentList instance
# colData() - the primary/phenotype DFrame
# sampleMap() - the sample availability DFrame
...
#   [1] raw: SummarizedExperiment with 323 rows and 4 columns
# [2] imputed: SummarizedExperiment with 323 rows and 4 columns
# [3] norm: SummarizedExperiment with 323 rows and 4 columns
# [4] norm_imputed: SummarizedExperiment with 323 rows and 4 columns
# Features:
#   experiments() - obtain the ExperimentList instance
# colData() - the primary/phenotype DFrame
# sampleMap() - the sample availability DFrame
